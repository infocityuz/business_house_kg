    ...
    <div class="d-flex aad">
        ...
        <div class="mainMargin">
            ...
            <div class="d-flex justify-content-between" style="width: 992px;">
                <div class="d-flex">
                    <h2 class="panelUprText profileTextProfile">{{translate('Profile')}}</h2>
                </div>
            </div>
            ...
            <div class="d-flex profileMax1920" style="margin-bottom: 100%;">
                <div>
                    ...
                    <div class="d-flex">
                        @if($user->id == $model->id)
                            <h2 class="panelUprText">{{translate('My stats')}}</h2>
                        @else
                            <h2 class="panelUprText">{{translate('Stats')}}</h2>
                        @endif
                    </div>
...
{{--                                <img class="chartGreenImageOne" src="{{asset('/backend-assets/forthebuilders/images/GreenChart.png')}}" alt="GreenChart">--}}
...
{{--                                <p class="greenChartZadachiName">{{translate('In work')}}</p>--}}
{{--                                <div class="greenChartYellowRadius"></div>--}}
{{--                            </div>--}}
                        ...
                        <div class="greenChartMoyiProdaj">
                            <h5 class="MoyiZadachiTextCartGreenH5">{{translate('Tasks')}}</h5>
{{--                            <img class="greenImageChartTwo" src="{{asset('/backend-assets/forthebuilders/images/GreenChart (1).png')}}" alt="GreenChart">--}}
