    ...
    public function showDetails($house_id, $entrance, $flat_id)
    {
        ...
        foreach ($flats as $val) {
            ...
            if ($val->status == Constants::STATUS_BOOKING) {
                ...
                $arr['list'][$f_j][$n]['client_id'] = (isset($val->booking->clients)) ? $val->booking->clients->id : 0;
                ...
                $arr['list'][$f_j][$n]['client_id'] = (isset($val->deal->client)) ? $val->deal->client->id : 0;
            }
