...
<script defer>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            models.name.push("{{$model_->performer->first_name}}")
            models.surname.push("{{$model_->performer->last_name}}")
            models.middlename.push("{{$model_->performer->middle_name}}")
            models.created_at.push("{{$model_->created_at}}")
            models.email.push("{{$model_->performer->email}}")
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                events: [
                        ...
                        @endphp
                    {
                        ...
                        url: '#',
                        title : "{{$model->performer->first_name}} <br> {{$model->status}} {{$model->type}}",
                        customHtml : "<span>{{$model->performer->first_name.' '}}{{$model->performer->last_name}} <br> {{$model->user->first_name}}</span>",
