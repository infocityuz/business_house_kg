...
class HouseFlatRequest extends BaseFormRequest
{
    ...
    public function store()
    {
        return [
            ...
            'area_total' => 'nullable|numeric|between:0,100000000.99',
            'area_bedroom' => 'nullable|numeric|between:0,100000000.99',
            'area_hotel' => 'nullable|numeric|between:0,100000000.99',
