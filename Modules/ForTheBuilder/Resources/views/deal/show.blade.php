                                            ...
                                            @if ($val->type == 1)
                                                <div class="informatsiyaKlienta" style="height: 224px">
                                                    ...
                                                    <div class="d-flex justify-content-between" style="display: none !important;">
                                                        ...
                                                        @endphp
                                                        @if (is_array($areas))
                                                            <button class="klientNameInformatsiaButtonKontactYellow" house_id="{{$val->house_id??'NULL'}}" house_flat_id = "{{$val->house_flat_id??'NULL'}}" client_id = "{{$val->client_id??'NULL'}}"
                                                                    id="interested_flat">{{ $val->house_name . ': ' . translate('entrance') . $val->flat_entrance.' '.$val->flat_number . ' flat: ' . $areas['total']}}
                                                            </button>
                                                        @else
                                                            <button class="klientNameInformatsiaButtonKontactYellow" house_id="{{$val->house_id??'NULL'}}" house_flat_id = "{{$val->house_flat_id??'NULL'}}" client_id = "{{$val->client_id??'NULL'}}"
                                                                    id="interested_flat">{{ $val->house_name . ': ' . translate('entrance') . $val->flat_entrance.' '.$val->flat_number.' flat' }}
                                                            </button>
                                                        @endif
                                                    </div>
                                                </div>
                                            ...
                                            @elseif($val->type == 3)
                                                <div class="informatsiyaKlienta" style="height: 470px">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        @if (is_array($areas))
                                                            <button class="klientNameInformatsiaButtonKontactYellow" house_id="{{$val->house_id??'NULL'}}" house_flat_id = "{{$val->house_flat_id??'NULL'}}" client_id = "{{$val->client_id??'NULL'}}"
                                                                    id="interested_flat">{{ $val->house_name . ': ' . translate('entrance') . $val->flat_entrance.' '.$val->flat_number . ' flat: ' . $areas['total']}}</button>
                                                        @else
                                                            <button class="klientNameInformatsiaButtonKontactYellow" house_id="{{$val->house_id??'NULL'}}" house_flat_id = "{{$val->house_flat_id??'NULL'}}" client_id = "{{$val->client_id??'NULL'}}"
                                                                    id="interested_flat">{{ $val->house_name . ': ' . translate('entrance') . $val->flat_entrance.' '.$val->flat_number.' flat' }}</button>
                                                        @endif
                                                    </div>
                                                    <div>
                                                        <form action="{{route('forthebuilder.clients.storePhoto')}}" method="POST" class="d-flex justify-content-around" style="padding: 4px 20px 0px 0px" enctype="multipart/form-data">
                                                            ...
                                                            @if(file_exists($file_url))
                                                                ...
                                                                @endif
                                                            @else
                                                                <a href="{{ asset('/uploads/flat/apartment.jpg') }}">
                                                                    <img class="inforMatsiyaClienti2MiniImage"
                                                                         src="{{ asset('uploads/flat/apartment.jpg') }}"
                                                                         alt="Image">
                                                                </a>
                                                            @endif
        ...
        <div class="d-flex justify-content-center">
            <div class="modal-content store_budget_form"
                ...
                <form class="modal-body" id="store_budget_"
                      action="{{ route('forthebuilder.clients.storeBudget', $client_id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-3">
                        ...
                        @if ($house_flat != '')
                            ...
                            <div class="d-flex">
                                <span class="plusFlexModalInformationDobavitCvartir">{{ $house_flat->house->name . ' ' . $house_flat->number_of_flat . '-flat' }}</span>
                            </div>
                            <div class="d-flex">
                        ...
                        <div class="deal_status_content">
                            ...
                            <div class="deal_status d-none">
                                <button value="{{ Constants::FIRST_CONTACT }}" class="status_first_contact"
                                ...
                                <a value="{{ Constants::MAKE_DEAL }}" class="status_making_a_deal"
                                   id="making_a_deal_id" client_id="{{$client_id}}" type="submit">{{ translate('Making a deal') }}
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (adding_flat != null) {
            adding_flat.addEventListener('click', function() {
                ...
                window.location.href = "{{ route('forthebuilder.client.house', $client_id) }}";
            })
        }
        if (house_flat == "") {
        ...
        first_contact_id.addEventListener('click', function() {
        ...
        negotiation_id.addEventListener('click', function() {
