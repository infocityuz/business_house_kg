            ...
            <div class="kursValyutaDataBig">
                <div class="kursValyutaData">
                    <div class="d-flex">
                        ...
                        <div class="kursValyutaUsd">
                            {{-- <img style="width:70px" src="{{ asset('backend-assets/forthebuilders/images/kirgiz.jpg') }}" alt="Uzb"> --}}
                            <img height="30" style="border-radius:5px"
                                src="{{ asset('/backend-assets/forthebuilders/images/kirgiz.jpg') }}"
                                alt="Uzb">
                        </div>
                    </div>
                ...
                <div class="kursValyutaData">
                    @if ($model)
                        <div class="d-flex">
                            ...
                            <div class="kursValyutaUsd">
                                <input type="text" value="{{ $model->USD }}" class="kursValyutaWhite currencyUpdate currencyUpdateUsd"
                                    disabled data-status="USD">
                                {{-- <div class="kursValyutaWhite">{{$model->USD}}</div> --}}
                            </div>
                            <div class="kursValyutaUsd">
                                <input type="text" value="{{ $model->SUM }}" class="kursValyutaWhite currencyUpdate currencyUpdateUzs"
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="#" class="seaDiv d-none" id="saveCurrencyUpdateButton" title="Save"
                        style="margin-right: 10px; text-align: center">
                        {{-- {{ route('forthebuilder.currency.create') }} --}}
                        <img class="mt-1" width="20" height="20"
                            src="{{ asset('/backend-assets/forthebuilders/images/Verifed.png') }}" alt="Edit">
                    </a>
                    <form style="display: inline-block;" action="{{ route('forthebuilder.currency.destroy') }}"
                        method="POST" id="deleteCurrencyUpdateButton">
                        @csrf
                        @method('DELETE')
