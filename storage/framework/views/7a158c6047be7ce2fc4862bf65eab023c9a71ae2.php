...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sozdatImyaSpsok">
                        ...
                        <div class="d-flex">
                            <div>
                                <img style="width:70px" src="<?php echo e(asset('backend-assets/forthebuilders/images/kirgiz.jpg')); ?>" alt="Region">
                            </div>
                            <div>
                                <label
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sozdatImyaSpsok">
                        ...
                        <input class="sozdatImyaSpisokPinfl <?php $__errorArgs = ['inn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/business_house/Modules/ForTheBuilder/Resources/views/clients/create.blade.php ENDPATH**/ ?>