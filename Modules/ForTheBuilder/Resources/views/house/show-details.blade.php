                            ...
                            <div class="d-flex mb-4">
                                <div class="custom-select modalSelect" style="width:200px;">
                                    ...
                                    <select class="selectModal">
                                        ...
                                        <option @if ($val['status'] == HouseFlat::STATUS_FREE)  selected @endif  data-select="{{ HouseFlat::STATUS_FREE }}"
                                            value="{{ HouseFlat::STATUS_FREE }}">
                                            {{ translate('Free') }}</option>
                                        <option @if ($val['status'] == HouseFlat::STATUS_BOOKING)  selected @endif data-select="{{ HouseFlat::STATUS_BOOKING }}" id="zanyatiOption"
                                            data-toggle="modal" data-target="#exampleModal2"
                                            value="{{ HouseFlat::STATUS_BOOKING }}">
                                            {{ translate('Busy') }}</option>
                                        <option @if ($val['status'] == HouseFlat::STATUS_SOLD) selected @endif data-select="{{ HouseFlat::STATUS_SOLD }}"
                                ...
                                <div class="client-show-buttons showDetailsStatusBooking d-none"
                                    style="background-color: #F7FF9C; width:200px; border-radius: 20px; height: 50px; display: flex; justify-content: center; align-items: center; text-align: center; border: none;">
                                    {{ translate('Busy') }}
                                </div>
                                <div>
                                    {{-- house-flat/show/${fId} --}}
