...
<div class="d-flex ajaxCliDiv">
    ...
    <div style="max-width: 169px; display: flex; margin-right: 80px;">
        <div class="dropdown">
            {{--            <button class="d-flex buttonUzbDropDownHeader dropdown-toggle"  type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="{{asset('/backend-assets/forthebuilders/images/notification.png')}}" alt="Notification"> --}}
            {{--                <img class="notifRegion" src="{{asset('/backend-assets/forthebuilders/images/notification.png')}}" alt="Notification"> --}}
            {{--                <div class="notifRegionNumber">1</div> --}}
            {{--            </button> --}}
            @php
                    ...
                    @if ($all_count > 0)
                        ...
                        @foreach ($all_notifications['all_installment_plan'] as $installment_notification)
                            ...
                            <a href="{{ route('forthebuilder.installment-plan.show', $installment_data->id) }}">
                                ...
                                <p class="humoanSmsDropdown">
                                <span class="humoanSmsDropdownSpan float-right text-sm">
                                    {{ date('m/d h:i', strtotime($notification_data->expire_dates)) }}
                                </span>
                                </p>
                            </a>
                            <hr style="margin: 0px 12px; margin-top: 44px;">
