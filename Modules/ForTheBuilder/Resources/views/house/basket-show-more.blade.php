                                    ...
                                    @empty(!$arr['list'])
                                        @foreach ($val['list'] as $key2 => $val2)
                                            <div class="d-flex hover-remove-add">
                                                <h2 class="etajNameNomerDale" style="min-width: 30px; margin-top: 10px;">
                                                    {{ $key2 }}</h2>
                                                @foreach ($val2 as $val3)
                                                    ...
                                                    <div style="min-width: 60px; height: 50px;">
                                                        ...
                                                        <button
                                                            ...
                                                            disabled data-id="{{ $val3['id'] }}"
                                                            data-disabled="{{ $disabled }}"
                                                            data-category="{{ $val3['color_status'] }}"
                                                            data-def='0'>{{ $val3['room_count'] ?? 0 }}</button>
                                                    </div>
                                                @endforeach
                                                <div class="floor-action d-none"
                                                    style="min-width: 60px; height: 50px; margin-bottom: 10px">
                                                    <i class="fa fa-trash float-left bascket-float-remove"
                                                        data-house-id="{{ $model->id }}" data-entrance="{{ $val['entrance'] }}"
                                                        data-floor="{{ $key2 }}" style="color: red; cursor: pointer;"></i>
                                                    &nbsp; &nbsp;
