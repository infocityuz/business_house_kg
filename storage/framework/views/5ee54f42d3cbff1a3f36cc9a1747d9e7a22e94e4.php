...
<?php $__env->startSection('title'); ?> <?php echo e(translate('User create')); ?> <?php $__env->stopSection(); ?>
<link rel="stylesheet" href="<?php echo e(asset('/backend-assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('/backend-assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
        ...
        <div class="mainMargin">
            <?php echo $__env->make('forthebuilder::layouts.content.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <div class="d-flex justify-content-between">
                    <div class="d-flex">
                        <a href="<?php echo e(route('forthebuilder.user.index')); ?>" class="plus2 profileMaxNazadInformatsiyaKlient"><img src="<?php echo e(asset('/backend-assets/forthebuilders/images/icons/arrow-left.png')); ?>" alt=""></a>
            ...
            <div class="sozdatPolzavatelData">
                <form action="<?php echo e(route('forthebuilder.user.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="sozdatImyaSpsok">
                        ...
                        <input name="first_name" class="sozdatImyaSpisokInput <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>" type="text" value="<?php echo e(old('first_name')); ?>" required>
                    </div>

                    <div class="sozdatImyaSpsok">
                        <h3 class="sozdatImyaSpisokH3"><?php echo e(translate('Lastname')); ?></h3>
                        <input name="last_name" class="sozdatImyaSpisokInput <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('last_name')); ?>" required type="text">
                    </div>

                    <div class="sozdatImyaSpsok">
                        <h3 class="sozdatImyaSpisokH3"><?php echo e(translate('Middlename')); ?></h3>
                        <input name="middle_name" class="sozdatImyaSpisokInput <?php $__errorArgs = ['middle_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('middle_name')); ?>" type="text">
                    </div>

                    <div class="sozdatImyaSpsok">
                        <h3 class="sozdatImyaSpisokH3"><?php echo e(translate('Email')); ?></h3>
                        <input name="email" class="sozdatImyaSpisokInput <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" required type="email">
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <div class="sozdatImyaSpsok">
                                ...
                                <select required name="role_id" id="role_id"  data-placeholder="<?php echo e(__('locale.role')); ?>" class="sozdatImyaSpisokInput1272 <?php $__errorArgs = ['role_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" >
                                    <option value="">---------------------</option>
                                    <option value="1"><?php echo e(translate('Administrator')); ?></option>
                                    <option value="2"><?php echo e(translate('Manager')); ?></option>
                                </select>
                            </div>
