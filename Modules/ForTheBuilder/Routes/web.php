...
Route::group(['prefix' => 'forthebuilder', 'middleware' => ['auth', 'forthebuilder']], function () {
    ...
    Route::group(['prefix' => 'clients'], function () {
        ...
        Route::delete('/destroy/{id}', [ClientsController::class, 'destroy'])->name('forthebuilder.clients.destroy')->middleware('can:isAdmin');
    ...
    Route::group(['prefix' => 'installment-plan'], function () {
        ...
        Route::delete('/destroy/{id}', [InstallmentPlanController::class, 'destroy'])->name('forthebuilder.installment-plan.destroy')->middleware('can:isAdmin');
